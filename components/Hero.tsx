      ...
      <div className="custom-container py-10 max-sm:py-0 px-16">
         <div className="flex gap-5 justify-center">
            ...
            >
               <img
                  ...
                  src={"https://optim.tildacdn.com/tild6232-6131-4839-a561-663932333939/-/cover/400x600/center/center/-/format/webp/side-view-romantic-c.jpg"}
                  // width={1000}
                  // height={1000}
                  alt="photo"
               />
         ...
         <div className="mt-5 pl-9 relative">
            ...
            <motion.div
               ...
               className=""
            >
               <h1 className="text-[48px] leading-10">Mirsaid</h1>
               <h2 className="text-7xl font-[champignon] font-normal leading-[0.8] ">
                  and
               </h2>
               <h1 className="text-[48px] leading-8">Marjona</h1>
            </motion.div>
         </div>
      </div>
   );
